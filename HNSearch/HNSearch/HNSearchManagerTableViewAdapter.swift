...
class HNSearchManagerTableViewAdapter<CellType: UITableViewCell>:
NSObject, UITableViewDataSource, HNSearchManagerUpdate { //, UpcomingTaskDataManagerDelegate
    ...
    init(tableView: UITableView,
        upcomingTaskDataManager: HNSearchManager,
        cellReuseIdentifier: String,
        cellConfigurationHandler: (CellType, HNItem) -> (),
    ...
    func tableView(tableView: UITableView,
        ...
        //upcomingTaskDataManager.deleteTask(upcomingTaskDataManager.
            //taskSections[indexPath.section].
            //items[indexPath.row])
    }
